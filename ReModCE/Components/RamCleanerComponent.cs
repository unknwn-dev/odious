...
namespace ReModCE.Components
{
    internal class RamCleanComponent : ModComponent
    {
        ...
        public override void OnUiManagerInit(UiManager uiManager)
        {
            ...
            var menu = uiManager.MainMenu.GetCategoryPage("Utility").GetCategory("Ram Cleaner");
            menu.AddButton("Clear VRam",
                "Cleans ram (Shouldn't be needed but just incase).", CleanRam, ResourceManager.GetSprite("remodce.dust"));

            ReModCE.WingUtilityMenu.AddButton("Clear VRam",
                "Cleans ram (Shouldn't be needed but just incase).", CleanRam, ResourceManager.GetSprite("remodce.dust"));
        }
