...
namespace ReModCE.Components
{
    internal class ComfortMenuComponent : ModComponent
    {
        ...
        public override void OnUiManagerInit(UiManager uiManager)
        {
            ...
            var menu = uiManager.MainMenu.GetCategoryPage("Utility").GetCategory("Comfort menu");
            _comfyMenuToggle = menu.AddToggle("Comfort Menu",
            ...
            if (ComfyMenuEnabled)
            {
                ...
                ReModCE.Harmony.Patch(PlaceUiMethod, GetLocalPatch(nameof(PlaceUiPatch)));
            }
        }
